    ...
    <section class="result-card overview-card">
      <div class="performance-summary">
        ${kpiCard("\u4EA7\u80FD", performance2.throughputPerHour > 0 ? performance2.throughputPerHour.toFixed(1) : "\u2014", performance2.throughputPerHour > 0 ? "\u7247/h" : "", performance2.throughputSampleCount ? `\u5C45\u4E2D ${performance2.throughputSampleCount} \u7247\u7A33\u6001\u6837\u672C` : escapeHtml(performance2.throughputReason || "\u6837\u672C\u4E0D\u8DB3\uFF0C\u5B8C\u5DE5\u7247\u6570\u5FC5\u987B\u5927\u4E8E 150"), "is-primary")}
          ${kpiCard("\u5E73\u5747\u91CD\u7B97\u65F6\u95F4", Number.isFinite(performance2.averageRecomputeTimeMs) ? Number(performance2.averageRecomputeTimeMs).toFixed(1) : "\u2014", Number.isFinite(performance2.averageRecomputeTimeMs) ? "ms" : "", performance2.recomputeCount ? `\u9996\u6B21\u53D1\u9001\u81F3\u672B\u6B21\u8F93\u51FA / ${performance2.recomputeCount} \u6B21\u91CD\u7B97` : "\u6CA1\u6709\u8C03\u5EA6\u8F6E\u6B21")}
...
async function createTestGroup() {
  ...
  try {
    ...
    if (error.message === "Not found") throw new Error("\u672C\u5730\u670D\u52A1\u7248\u672C\u8FC7\u65E7\uFF0C\u8BF7\u91CD\u542F app.backend.main \u540E\u518D\u65B0\u5EFA\u7EC4\u522B");
    throw error;
  }
...
async function checkService() {
  ...
  try {
    ...
    if (!compatible) {
      ...
      writeTerminal("$ \u672C\u5730\u670D\u52A1\u7248\u672C\u8FC7\u65E7\n  \u8BF7\u91CD\u542F: python -m app.backend.main", true);
    }
  } catch {
    ...
    pill.style.color = "var(--red)";
    pill.style.background = "var(--red-soft)";
    writeTerminal("$ \u65E0\u6CD5\u8FDE\u63A5\u672C\u5730\u670D\u52A1\n  \u8BF7\u8FD0\u884C: python -m app.backend.main", true);
  }
}
